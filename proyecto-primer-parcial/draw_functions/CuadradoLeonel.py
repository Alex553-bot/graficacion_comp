...
def dibujarCuadrado(canvas, pts:list, g:int, segm:bool):
    if segm:
        ...
        pass
        """
        line_dda(canvas, pts[0][0], pts[0][1], pts[1][0], pts[1][1], g)
        line_dda(canvas, pts[1][0], pts[1][1], pts[2][0], pts[2][1], g)
        line_dda(canvas, pts[2][0], pts[2][1], pts[3][0], pts[3][1], g)
        line_dda(canvas, pts[3][0], pts[3][1], pts[0][0], pts[0][1], g)
    #canvas = Canvas(raiz)
