...
def fill_pixel(canvas, x, y, fill_color):
    canvas.create_rectangle(x, y, x, y, fill=fill_color)
...
def boundary_fill_4(canvas, x, y, fill_color, boundary_color):
    ...
    if pixel_color != fill_color and pixel_color != boundary_color:
        ...
        boundary_fill_4(canvas, x, y - 3, fill_color, boundary_color)
        boundary_fill_4(canvas, x - 3, y, fill_color, boundary_color)
        boundary_fill_4(canvas, x, y + 3, fill_color, boundary_color)
        boundary_fill_4(canvas, x + 3, y, fill_color, boundary_color)
